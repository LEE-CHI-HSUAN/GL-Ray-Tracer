...
void SceneConfig::loadScene2(Scene &scene)
{
    ...
    scene.addCameraKeyframe(Keyframe{.time = 5.0, .position = glm::vec3(-3.12, 1.56, -5.11), .rotation = glm::vec3(-25, -55.2, -1.56), .scale = glm::vec3(1, 1, 1)});
    scene.addCameraKeyframe(Keyframe{.time = 6.0, .position = glm::vec3(-3.12, 1.56, -5.11), .rotation = glm::vec3(-25, -55.2, -1.56), .scale = glm::vec3(1, 1, 1)});
    scene.addCameraKeyframe(Keyframe{.time = 11.0, .position = glm::vec3(4.79, -1.13, -8.60), .rotation = glm::vec3(12, 117.8, -1.23), .scale = glm::vec3(1, 1, 1)});
    scene.addCameraKeyframe(Keyframe{.time = 12.0, .position = glm::vec3(4.79, -1.13, -8.60), .rotation = glm::vec3(12, 117.8, -1.23), .scale = glm::vec3(1, 1, 1)});
}
